...
<div class="pace-activity"></div></div>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <form class="navbar-form navbar-right search-box" action="<?=$_SERVER['PHP_SELF']?>" method="post">
                <div class="form-group pull-left">
                    <input name="word" type="text" class="form-control search-field" placeholder="搜索一下">
                </div>
                <input type="submit" class="btn btn-default pull-left search-btn" value="搜索" name="submit">
            </form>
        </div>
    </div>
</nav>
