    ...
    if (isset($_SESSION["code"])){
        ...
        {  
            ...
            {  
                ...
                $sql_insert = "insert into content (username,title,content,image,image1,image2,image3,type,price) values ('$theuser','$_POST[title]','$_POST[content]','$dest[0]','$dest[1]','$dest[2]','$dest[3]','$thetype',$_POST[price])";  
