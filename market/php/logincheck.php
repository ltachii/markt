<?php  
    ...
    {  
        ...
        {  
            ...
            if($num)  
            { 
                $sql1 = "select username,password from regcheck where username = '$_POST[username]' and password = '$_POST[password]' and examine = 1";  
                ...
                if($num1){ 
                    ...
                    echo "<script>alert('等待管理员确认！');history.go(-1);</script>";
                }
