...
<?php
    $thekey = $_GET['id'];
    $sql = "select * from content where id = '$thekey'";
    ...
    <div class="main">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <form action="php/carticle.php?id=<?php echo $row['id'];?>" method="post"  enctype="multipart/form-data" class="form-horizontal m-t">
                    <div class="form-group">
                        <label class="col-sm-3 control-label">标题：</label>
                        <div class="col-sm-8">
                            <input name="title" class="required form-control" type="text" placeholder="<?php echo $row['title']; ?>" aria-required="true">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">详情：</label>
                        <div class="col-sm-8">
                            <textarea name="content" placeholder="<?php echo $row['content']; ?>" class="form-control" type="text" aria-required="true" aria-invalid="false"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">价格：</label>
                        <div class="pre-price input-group m-b col-sm-8">
                            <input name="price" type="text" class="form-control" placeholder="<?php echo $row['price']; ?>"> <span class="input-group-addon">.00</span>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-8 col-sm-offset-3">
                            <input type="submit" class="btn btn-primary btn-block" value="确定修改" name="submit">
                        </div>
                    </div>
