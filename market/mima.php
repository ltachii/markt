...
<body class="signin  pace-done" background = "images/5.jpg";>
        ...
        <div class="row">
            <div class="col-sm-7">
                <div class="signin-info">
                    ...
                    <ul class="m-b">
                        <div class="erweima">
                            <img src="images/56d792395ebe9.png">
                            <p class="text">扫一扫，或百度:西瓜校园</p>
                        </div>
                    </ul>
                </div>
            </div>
            <div class="col-sm-5">
                <form method="post" id="js-form" action="php/mima.php" method="post">
                    <h4 class="no-margins">修改密码</h4>
                    <input type="password" name="password" id="password" class="form-control uname" placeholder="请输入原密码">
                    <input type="password" name="newpass" id="newpass" class="form-control pword m-b" placeholder="请输入新密码">
                    <div class="checkbox i-checks">
                        
                    </div>
                    <input type="submit" name="submit" class="btn btn-success btn-block submit_btn" value="确定修改" />
                </form>
            </div>
        </div>
        <div class="signup-footer">
            <div class="pull-left">
                版权所有 © All Rights Reserved，鲁ICP备66666666号-6    
            </div>
        </div>
    </div>
...
<script src="js/icheck.min.js.下载"></script>
<script type="text/javascript" src="js/login.js.下载"></script>
</body>
</html>