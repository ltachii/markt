    ...
    <div class="main">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <form action="php/article.php" method="post"  enctype="multipart/form-data" class="form-horizontal m-t">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name='myfile[]' id="addBtn" style="position: absolute; width: 49%; height: 32px; left: 492px; z-index: 1; opacity: 0;">
                        <div class="col-sm-8">
                            <div data-toggle="modal"  data-target="#myModal1" class="modal-btn btn btn-default btn-block">点击上传</div>
                        </div>
                    </div>
                    <div class="form-group">

                        <label class="col-sm-3 control-label">相册1：<!-- <span class="badge badge-warning " id="tip2">？</span> --></label>
                        <input type="file" name='myfile[]' id="addBtn" style="position: absolute; width: 49%; height: 32px; left: 492px; z-index: 1; opacity: 0;">
                        <div class="col-sm-8">
                            <div data-toggle="modal"  data-target="#myModal2" class="modal-btn btn btn-default btn-block">点击上传</div>
                        </div>
                    </div>
                    <div class="form-group">

                        <label class="col-sm-3 control-label">相册2：<!-- <span class="badge badge-warning " id="tip2">？</span> --></label>
                        <input type="file" name='myfile[]' id="addBtn" style="position: absolute; width: 49%; height: 32px; left: 492px; z-index: 1; opacity: 0;">
                        <div class="col-sm-8">
                            <div data-toggle="modal"  data-target="#myModal2" class="modal-btn btn btn-default btn-block">点击上传</div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-3 control-label">相册3：<!-- <span class="badge badge-warning " id="tip2">？</span> --></label>
                        <input type="file" name='myfile[]' id="addBtn" style="position: absolute; width: 49%; height: 32px; left: 492px; z-index: 1; opacity: 0;">
                        <div class="col-sm-8">
                            <div data-toggle="modal" data-target="#myModal2" class="modal-btn btn btn-default btn-block">点击上传</div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select style="width: 100%; height: 32px;" name="choose">
                                ...
                                {
                                ?> 
                                        <option value="<?php echo $row1['id']; ?>"><?php echo $row1['thename']; ?></option>
                                          <?php  
                                    }
                                    ?>
                            </select>
