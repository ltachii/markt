...
<div class="container-fluid">
   <ul id="middle_nav" class="clearfix row">
       <li class="item-info col-lg-2 current"><a href="#">个人资料</a></li>
       <li class="item-info col-lg-2"><a href="coll.php?id=<?php $thename = $row2['username']; echo $thename; ?>">我的收藏</a></li>
       <li class="item-info col-lg-2"><a href="fabu.php?id=<?php $thename = $row2['username']; echo $thename; ?>">我的发布</a></li>
   <li class="back" style="left: 0px; width: 170px; overflow: hidden;"><div class="left"></div></li></ul>
</div>
        ...
        <div id="my_info">
            ...
            <div id="base_info">
                <form action="php/mypho.php" method="post">
                <h2>基本信息 <span id="edit_info">编辑</span><input type="submit" name="submit" id="save_info" value="完成"></h2>
                <ul class="infos">
                    <!--<li>昵称</li>
                    <li class="right_info">
                        <span id="nickname_span">weishenmene</span>
                        <input value="weishenmene" id="nickname" type="text">
                    </li>-->
                </ul>
                <ul class="infos">
                    <li>手机</li>
                    <li class="right_info">
                        <span id="phone_span"><?php echo $row['phone']; ?></span>
                        <input id="phone" type="text" value="<?php echo $row['phone']; ?>" name="phone">
                    </li>
                </ul>
                <ul class="infos">
                    <li>qq</li>
                    <li class="right_info">
                        <span id="qq_span"><?php echo $row['qq']; ?></span>
                        <input value="<?php echo $row['qq']; ?>" id="qq" type="text" name="qq">
                    </li>
                </ul>
                <ul class="infos">
                    <li>微信</li>
                    <li class="right_info">
                        <span id="qianming_span"><?php echo $row['wechat']; ?></span>
                        <input value="<?php echo $row['wechat']; ?>" id="qianming" type="text" name="wechat">
                    </li>
                </ul>
                <ul class="infos">
                    <li>签名</li>
                    <li class="right_info">
                        <span id="qianming_span"><?php echo $row['synopsis']; ?></span>
                        <input value="<?php echo $row['synopsis']; ?>" id="qianming" type="text" name="content">
                    </li>
                </ul>
            </form>
            </div>
