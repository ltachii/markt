    ...
    <div class="main">
        <div class="box">
            ...
            <ul class="goodsbox clearfix">
                ...
                $con = mysql_connect("localhost","root","root");//链接数据库
                mysql_select_db('regest',$con);//选择数据库
                $sql = "select * from want order by price";
                ...
                <div style="width: 1132px;height: 150px;background: #ffffff; margin: 35px 0 0 31px;">
                    ...
                    <div style="width: 950px;height: 100px;float: left;">
                        ...
                        <p style="    color: rgb(70,70,70);font-size: 14px;font-weight: normal;height: 16px;line-height: 16px;margin-top: 10px;">期望价格：￥<?php echo $row['price']; ?>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp发布时间：<?php echo $row['thetime']; ?></p>
