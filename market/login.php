...
<div class="pace-activity"></div></div>
    <div class="signinpanel">
        <div class="row">
            ...
            <div class="col-sm-5">
                <form method="post" id="js-form" action="php/logincheck.php" method="post">
                    <h4 class="no-margins">登录西瓜校园</h4>
                    <input type="text" name="username" id="username" class="form-control uname" placeholder="用户名或邮箱">
                    <input type="password" name="password" id="password" class="form-control pword m-b" placeholder="密码">
                    <div class="checkbox i-checks">
                        
                        <a href="registration.php">注册账号</a>
                    </div>
                    <input type="submit" name="submit" class="btn btn-success btn-block submit_btn" value="登录" />
                </form>
            </div>
        </div>
