    ...
    <div class="main">
        <div class="box">
            ...
            <ul class="goodsbox clearfix">
                ...
                $sql = "select * from regcheck where examine = 1";
                ...
                <div style="width: 1132px;height: 150px;background: #ffffff; margin: 35px 0 0 31px;">
                    ...
                    <div style="width: 950px;height: 100px;float: left;">
                        ...
                        <p style="    color: rgb(58,58,58);font-size: 17px;font-weight: normal;line-height: 120%;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;"><?php echo $row['synopsis']; ?></p>
                        <p style="    font-weight: normal;font-size: 13px;display: inline-block;margin-right: 20px;">手机：  <?php echo $roww['phone']; ?> &nbsp&nbsp&nbsp QQ：<?php echo $roww['qq']; ?> &nbsp&nbsp&nbsp 微信： <?php echo $roww['wechat']; ?></p>
                    </div>

                    <div style="width: 50px; height: 20px;  position:absolute; left: 1200px;" onclick="window.location.href='loginout.php';">

                            <a href="php/delete1.php?id=<?php echo $roww['rid'];?>">删除</a>
