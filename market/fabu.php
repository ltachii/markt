...
<?php
        $sql = "select * from content where username = '$thename' and examine = 1";
        $result = mysql_query($sql);
        date_default_timezone_set("Asia/Shanghai");
        ...
        ?> 
                ...
                <div id="my_enshrine">
                    <div style="height: 130px; width: 100%">
                                <a class="clearfix pull-left" href="content.php?id=<?php echo $row['id'];?>">
                                        <img src="images/user/<?php echo $row['image']; ?>" class="enshr_ph" style="height: 120px;width: 120px; float: left;">
                                    </a>
                                                                    <div class="enshr_info">
                                    <h2 style="text-indent: 10px;"><a href="content.php?id=<?php echo $row['id'];?>"><?php echo $row['title']; ?></a></h2>
                                    <p style="text-indent: 10px;"><?php echo $row['content']; ?></p>
                            </div>                       <div class="text-center">
                            <nav><ul class="pagination"></ul></nav>                        </div>
                            <a href="php/delete.php?id=<?php echo $row['id'];?>" style="float: right;">删除</a>
                            <a href="change.php?id=<?php echo $row['id'];?>" style="position:relative;left: 774px;top:20px;">修改</a>
